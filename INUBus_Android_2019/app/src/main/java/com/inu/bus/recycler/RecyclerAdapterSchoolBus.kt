...
//                Log.d("0598","group Success")
        ...
        return when(type){
            ...
            RecyclerArrivalItem.ItemType.ArrivalInfo->
                ViewHolderArrivalItem(RecyclerArrivalItemBinding.inflate(layoutInflater, parent, false), isShowing, RecyclerAdapterArrival(""))
        }
    }
...
//        result.dispatchUpdatesTo(this)
        mFilteredItems = arrayListOf<RecyclerArrivalItem>(
                RecyclerArrivalItem(),
                RecyclerArrivalItem(),
                RecyclerArrivalItem()
        )
